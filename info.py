...
API_ID = int(environ.get('API_ID', '25948950')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', 'd046967218ac945703c70f3d15b11fc4')  # API Hash from my.telegram.org
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5298223577').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002116767957').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002686058050'))  # Log channel id (make sure bot is admin)
...
auth_channels     = environ.get("AUTH_CHANNELS", "-1002302092974")# Channels for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://baleny:zpQKH66B4AaYldIx@cluster0.ichdp1p.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the database
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://hohadagy:cYX0yKvm0CqUFtMo@cluster0.fcltkgy.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/cinewoodflixx') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/deletedaccount437') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/cinewood_flix') # Update channel link for the bot
